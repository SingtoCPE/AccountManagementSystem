    ...
    >
      <v-card>
        <v-col class="teal lighten-3">
          <h4>
            <v-icon class="mr-2">mdi-cash-multiple</v-icon>PAYROLL LISTING
          </h4>
        </v-col>
        <v-card
          height="43"
          color="white"
          outlined
          class="d-flex justify-end mr-2 mt-2"
        >
            ...
            <template v-slot:default>
              <thead>
                <tr style="height:70px;" class="grey lighten-3">
                  ...
                  <th class="text-left" style="width:130px;">Additions</th>
                  <th class="text-left" style="width:130px;">Deductions</th>
                  <th class="text-left" style="width:130px;">Net paid</th>
